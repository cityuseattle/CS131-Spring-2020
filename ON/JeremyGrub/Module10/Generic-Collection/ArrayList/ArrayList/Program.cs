...
namespace Arraylist
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            myArrList.Remove(10); //parameter is index number, in this case remove element with value of 10
            //now this array list has total of 5 elements

            myArrList.RemoveAt(0); //parameter is index number, in this case remove elements from index 0, which is now 11.5
            //now this array list 4 elements total
